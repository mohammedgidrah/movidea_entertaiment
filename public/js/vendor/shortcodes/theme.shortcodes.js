...
function melodyschool_sc_init_scroll_area(obj) {
    ...
    if (!melodyschool_check_images_complete(obj) && MELODYSCHOOL_STORAGE['scroll_init_counter']++ < 30) {
        setTimeout(function() {
            melodyschool_sc_init_scroll_area(obj);
        }, 200);
        return;
    }
        ...
        var o = {
            ...
            diagram: function() {
                ...
                r.circle(c, c, Math.round(w / 2)).attr({
                    stroke: 'none',
                    fill: MELODYSCHOOL_STORAGE['theme_bg_color'] ? MELODYSCHOOL_STORAGE['theme_bg_color'] : '#ffffff'
                });
        ...
        error = melodyschool_form_validate(form, {
            ...
            rules: [{
                ...
                },
                {
                    ...
                    min_length: {
                        value: 1,
                        message: MELODYSCHOOL_STORAGE['strings']['subject_empty']
                    },
                    max_length: {
                        value: 100,
                        message: MELODYSCHOOL_STORAGE['strings']['subject_long']
                    }
                },
                {
                    field: "message",
                    ...
                    max_length: {
                        value: MELODYSCHOOL_STORAGE['contacts_maxlength'],
...
function melodyschool_menuitems_show_popup(obj) {
    ...
    jQuery.post(MELODYSCHOOL_STORAGE['ajax_url'], {
        ...
        try {
            ...
            rez = {
                error: MELODYSCHOOL_STORAGE['ajax_error'] + '<br>' + response
            };
        }
