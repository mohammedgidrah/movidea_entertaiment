...
! function(jQuery, undefined) {
    ...
    function ajaxCallBack(opt, a) {
        ...
        var splitter = opt.ajaxCallback.split(")"),
            ...
            callback = splitter[0],
            callbackArgs = splitter.length > 1 && "" != splitter[1] ? splitter[1] + "," : "",
            obj = new Object;
        try {
            obj.containerid = "#" + opt.ajaxContentTarget, obj.postsource = a.data("ajaxsource"), obj.posttype = a.data("ajaxtype"), eval("on" == opt.ajaxCallbackArgument ? callback + "(" + callbackArgs + "obj)" : callback + "(" + callbackArgs + ")")
        } catch (e) {
